...
class LLMService:
    """Service for interacting with LLM APIs with retry logic.
    
    Supports OpenAI, XAI, or local LLM providers.
    """
    ...
    def __init__(self, settings: Settings):
        ...
        Args:
            settings: Configuration object with API keys and model settings
        """
        ...
        if settings.llm_provider == "openai":
            ...
            logger.debug(
                "local_client_configured",
                extra={"base_url": settings.local_llm_base_url}
            )
        else:
            logger.error(
            ...
            try:
                ...
                logger.warning(
                    ...
                    extra={
                        ...
                        "error_message": str(e)[:200],  # Truncate long msgs
